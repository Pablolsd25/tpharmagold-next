...
export default function Footer() {
  return (
    <footer className="bg-[#020202] border-t border-wix-gold/10">
      <div className="max-w-[980px] mx-auto px-4 sm:px-6 py-12">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="text-center sm:text-left">
            <p className="text-white font-display font-bold uppercase tracking-widest text-sm">
              {LEGAL.tradeNameAlt}
            </p>
            <p className="mt-1 text-zinc-500 text-xs">{LEGAL.tagline}</p>
          </div>
        ...
        <nav className="mt-8 flex flex-wrap justify-center gap-x-6 gap-y-2 text-xs">
          ...
          <Link href={LEGAL_LINKS.privacidad} className="text-zinc-500 hover:text-white transition-colors">
